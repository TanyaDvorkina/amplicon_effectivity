...
```{r}
res <- readResultFile("result.csv",TRUE, ",")
...
write.csv(thermoblast_data[1:100,], "../data/ForThermoBLAST1_p.csv", row.names=FALSE)
write.csv(thermoblast_data[101:200,], "../data/ForThermoBLAST2_p.csv", row.names=FALSE)
```
